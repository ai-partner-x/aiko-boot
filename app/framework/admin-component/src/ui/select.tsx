...
// 空值占位符（因为 Radix UI 不允许空字符串作为 value）
...
// 转换空值为占位符
const toInternalValue = (value: string) => value === '' ? EMPTY_VALUE_PLACEHOLDER : value;
// 转换占位符为空值
const toExternalValue = (value: string) => value === EMPTY_VALUE_PLACEHOLDER ? '' : value;
...
function Select({
  ...
  const handleValueChange = (newValue: string) => {
    const externalValue = toExternalValue(newValue);
  ...
  const internalDefaultValue = defaultValue !== undefined ? toInternalValue(defaultValue) : undefined;
