  ...
  return (
    <div className="min-h-screen bg-[#f5f6f7]">
      ...
      <div className="flex">
        ...
        <aside
          className={cn(
            'bg-white border-r border-gray-200/80 transition-all duration-300 flex-shrink-0 flex flex-col',
        ...
        >
          ...
          <div className="p-2 border-t border-gray-100">
            <button
              ...
              className="w-full h-9 rounded-lg flex items-center justify-center gap-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors"
            >
              {sidebarOpen ? (
                <>
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <path d="M7 2v14" />
                    <path d="M11 7l-2 2 2 2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <span className="text-xs font-medium">收起菜单</span>
                </>
              ) : (
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <rect x="2" y="2" width="14" height="14" rx="2" />
