...
export function EditPurchaseRequisitionPage() {
  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-6">
        {/* 彩色标题区 */}
        <div className={cn("bg-gradient-to-r text-white p-6 relative overflow-hidden", status.headerBg)}>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">修改采购物料明细</p>
              </div>
              <button
                onClick={addLineItem}
              ...
              <table className="w-full min-w-[800px]">
                <thead>
                  <tr className="bg-gray-50/80">
                    <th className="w-16 px-3 py-3 text-left text-xs font-semibold text-gray-600">行号</th>
                    <th className="px-3 py-3 text-left text-xs font-semibold text-gray-600">物料 <span className="text-red-500">*</span></th>
                    <th className="px-3 py-3 text-left text-xs font-semibold text-gray-600">物料描述</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {lineItems.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50/50">
                      <td className="px-3 py-2 text-sm text-gray-500">{item.lineNum}</td>
...
export default EditPurchaseRequisitionPage;
