...
const statusDistribution = [
  { status: 'draft', label: '草稿', count: 12, amount: 180000, color: 'bg-gray-400' },
  { status: 'pending', label: '待审批', count: 23, amount: 520000, color: 'bg-amber-500' },
  { status: 'approved', label: '已批准', count: 98, amount: 1650000, color: 'bg-emerald-500' },
  { status: 'rejected', label: '已拒绝', count: 8, amount: 120000, color: 'bg-red-500' },
  { status: 'processing', label: '处理中', count: 15, amount: 380000, color: 'bg-blue-500' },
];
                ...
                return (
                  <tr key={item.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <span className="text-sm font-medium text-blue-600">{item.prNumber}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-900">{item.description}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-600">{item.requester}</span>
                    </td>
                    <td className="px-6 py-4">
