...
import { DataTable, TableInput, TableText, type DataTableColumn } from '../../components/DataTable';
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-gray-500 border-b border-gray-200">
                    ...
                    <th className="pb-3 font-medium text-right">订单数量</th>
                    <th className="pb-3 font-medium text-right">已收货</th>
                    <th className="pb-3 font-medium text-right">本次收货 *</th>
                ...
                <tbody>
                  {materials.map((item, index) => (
                    <tr key={item.id} className="border-b border-gray-100">
                      ...
                      <td className="py-3 font-mono text-xs text-gray-600">{item.materialCode}</td>
                      <td className="py-3 text-gray-900">{item.materialName}</td>
                      <td className="py-3 text-right text-gray-600">{item.orderedQty}</td>
                      <td className="py-3 text-right text-gray-600">{item.receivedQty}</td>
                      <td className="py-3 text-right">
                        <input
                          ...
                          className="w-20 h-8 px-2 text-right rounded border border-gray-200 focus:outline-none focus:border-blue-400"
                        />
                      </td>
