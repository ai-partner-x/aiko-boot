      ...
      <div className="bg-white border-b border-gray-200 sticky top-14 z-40">
        <div className="max-w-6xl mx-auto px-6 py-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
            <button onClick={() => navigate('/purchase-requisitions')} className="hover:text-blue-600">
              采购申请管理
            </button>
            <span>/</span>
            <span className="text-gray-900">创建采购申请</span>
          </div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">创建采购申请</h1>
                <p className="text-sm text-gray-500 mt-0.5">新建采购申请项目</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 text-sm">
              <div className="flex items-center gap-2 text-gray-500">
                {Icons.calendar}
                <span>{headerData.requestDate}</span>
              </div>
              <div className="flex items-center gap-2 text-gray-500">
                {Icons.user}
                <span>{headerData.requester}</span>
              </div>
              <div className="flex items-center gap-2 text-gray-500">
                {Icons.building}
                <span>公司代码 {headerData.companyCode}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-blue-900">创建提示</p>
