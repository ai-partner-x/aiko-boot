...
export function CostCentersPage() {
  ...
  const renderDetail = (cc: CostCenter) => {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 text-white flex items-center justify-center">
              <span className="text-lg font-bold">{cc.ccCode.slice(-4)}</span>
            </div>
            <div className="flex-1">
              <h2 className="text-xl font-bold text-gray-900">{cc.ccName}</h2>
              <p className="text-sm text-gray-500 mt-1">{cc.ccCode} · {cc.department}</p>
            </div>
          </div>
