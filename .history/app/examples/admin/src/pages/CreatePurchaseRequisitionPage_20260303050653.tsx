  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="px-6 py-6 space-y-6">
        {/* SAP Fiori Create Page Header - 圆角卡片 */}
        <div className="rounded-lg overflow-hidden shadow-sm">
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-6 py-5">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-semibold">创建采购申请</h1>
                  <p className="text-sm text-white/80 mt-1">新建采购申请项目</p>
                  {/* 模式标签 */}
                  <span className="inline-block mt-2 px-2.5 py-0.5 text-xs font-medium bg-white/20 rounded-full">
                    新建模式
                  </span>
                </div>
              </div>
          ...
          {/* 关键信息区域 - 白色背景 */}
          <div className="bg-white px-6 py-4 border-t border-emerald-400/30">
