...
export function ViewPurchaseRequisitionPage() {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
              ...
              <p className="text-xs text-gray-500 mt-0.5">采购物料明细</p>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50/80">
                    ...
                    <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600">单价</th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600">金额</th>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600">交货日期</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {data.items.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50/50">
                      <td className="px-4 py-3 text-sm text-gray-500">{item.lineNum}</td>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-500">{item.deliveryDate}</td>
                    </tr>
                  ))}
                </tbody>
                <tfoot>
