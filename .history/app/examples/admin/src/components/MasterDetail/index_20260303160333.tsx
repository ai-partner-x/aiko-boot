    ...
    <div className="h-[calc(100vh-64px)] flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col bg-gray-50">
          {/* 顶部工具栏 */}
          <div className="flex-shrink-0 bg-gray-50 px-6 py-3 border-b border-gray-200 flex items-center justify-between">
            <div className="text-sm font-medium text-gray-600">
              {editMode === 'create' && '新建'}
              {editMode === 'edit' && '编辑'}
              {editMode === 'view' && selectedItem && '详情'}
            </div>
            <div className="flex items-center gap-2">
              {editMode === 'view' && selectedItem && (
                <>
                  ...
                  {allowDelete && onDelete && (
                    <Button variant="outline" size="sm" className="text-red-600 border-red-200 hover:bg-red-50 hover:border-red-300" onClick={handleDeleteClick}>
                      {Icons.delete}
