  ...
  return (
    <div className="relative">
      <select
        ...
        onChange={(e) => onChange(e.target.value)}
        className={cn(
          'w-full h-9 px-2.5 pr-8 rounded-lg border border-gray-200 bg-white text-sm focus:outline-none focus:border-blue-400 appearance-none',
          className
        )}
      >
