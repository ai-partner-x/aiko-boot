...
import type { User, CreateUserDto, UpdateUserDto } from '@user-crud/types';
...
const userSchema = z.object({
  ...
  age: z.coerce.number().min(1).max(150).optional().or(z.literal('')).transform(v => v === '' ? undefined : v),
});
