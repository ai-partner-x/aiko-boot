 ...
 * @ai-first/validation
 * 
 * Validation decorators based on class-validator
 * Compatible with Spring Boot Validation for Java transpilation
 * 
 * @example
 * ```typescript
 * import { IsNotEmpty, IsEmail, Length, Min, Max } from '@ai-first/validation';
 * 
 * class CreateUserDto {
 ...
 * import { createResolver, CreateUserDto } from '@ai-first/validation';
 * 
 * function UserForm() {
 ...
 * Used by @ai-first/codegen for Java transpilation
 */
